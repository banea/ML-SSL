...
public class InstanceValuePairTest {
	...
	double label = 0.0;
	InstanceValuePair monolingual = new InstanceValuePair(myInstance1, score, label);
	InstanceValuePair bilingual = new InstanceValuePair(myInstance1, myInstance2, score, label);
