...
public class ClassEvaluationTest {
  ...
  public void generateSetup(int tn_examples, int tp_examples, int fn_examples,
      int fp_examples) {
  ...
  public void testGetDatasetSize() {
    ...
    assertEquals("Number of samples in the dataset", 10000,
        myEvaluation.getDatasetSize());
  }
