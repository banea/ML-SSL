...
public class MaximumValueComparatorTest {
  ...
  int label = 0;
  InstanceValuePair monolingual1 = new InstanceValuePair(myInstance1, score1,
      label);
  InstanceValuePair monolingual2 = new InstanceValuePair(myInstance2, score2,
      label);
  ...
  public void testCompare() {
    System.out.println(myMaxComparator.compare(monolingual1, monolingual2)
        + " " + score1);
    assertTrue("Max comparison",
        -1 == myMaxComparator.compare(monolingual1, monolingual2));
  }
  ...
  public void testPriorityQueueComparator() {
    ...
    assertTrue("Instance value pairs have identical scores",
        result.getValue() == removed.getValue());
  }
